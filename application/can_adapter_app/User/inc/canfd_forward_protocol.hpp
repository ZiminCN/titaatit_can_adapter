...
typedef struct {
	...
	struct can_filter master_part_A_filter;
	can_rx_callback_t master_part_A_callback;
	struct can_filter master_part_B_filter;
	can_rx_callback_t master_part_B_callback;
	struct can_filter slave_filter;
	can_rx_callback_t slave_callback;
	struct can_filter forward_part_A_bus_filter;
	can_rx_callback_t forward_part_A_bus_callback;
	struct can_filter forward_part_B_bus_filter;
	can_rx_callback_t forward_part_B_bus_callback;
